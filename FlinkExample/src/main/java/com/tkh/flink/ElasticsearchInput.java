...
import org.apache.flink.elasticsearch6.shaded.org.elasticsearch.action.search.ClearScrollRequest;
...
import org.apache.flink.elasticsearch6.shaded.org.elasticsearch.action.search.SearchScrollRequest;
...
import org.apache.flink.elasticsearch6.shaded.org.elasticsearch.index.query.QueryBuilders;
import org.apache.flink.elasticsearch6.shaded.org.elasticsearch.search.Scroll;
...
public class ElasticsearchInput extends RichInputFormat<Row, InputSplit> implements ResultTypeQueryable<Row> {
    ...
    protected void search() throws IOException{
        ...
        if(scrollId == null){
            ...
            searchResponse = client.searchScroll(new SearchScrollRequest(scrollId).scroll(TimeValue.timeValueMinutes(3L)));
        }
